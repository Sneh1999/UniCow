...
contract TestUniCowHook is Test, Deployers {
    ...
    Currency ethCurreny = Currency.wrap(address(0));
    ...
    function setUp() public {
        ...
        deployCodeTo("UniCowHook.sol", abi.encode(manager), address(flags));

        hook = UniCowHook(address(flags));
    ...
    function test_beforeSwapPendingOrder() public {
        ...
        assertEq(
            manager.balanceOf(address(hook), ethCurreny.toId()),
            0.001 ether
        );
    }
}
